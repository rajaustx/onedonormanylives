...
interface AppreciationFormModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function AppreciationFormModal({ isOpen, onClose }: AppreciationFormModalProps) {
    ...
    >
      ...
      >
        <div className="flex shrink-0 items-center justify-between border-b border-stone-200/60 px-6 py-4 dark:border-stone-700/60">
          <h2 id="modal-form-heading" className="font-serif text-xl font-medium text-stone-900 dark:text-stone-100">
        ...
        <div className="overflow-y-auto px-6 py-6">
          <AppreciationForm variant="modal" />
        </div>
      </div>
    </div>
  );
