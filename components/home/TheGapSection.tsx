...
const stats = [
  ...
  {
    value: "1 donor",
    label: "Can start a chain of 10+ transplants",
...
export function TheGapSection() {
  return (
    <section id="the-gap" className="border-y border-stone-200/60 bg-stone-50/50 py-20 dark:border-stone-800/60 dark:bg-stone-900/30">
